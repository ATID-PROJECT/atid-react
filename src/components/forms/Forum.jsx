...
function Forum(props) {
  ...
  {
    userService.sendGETRequest('/questions/forum', { 
      uuid: uuid,
      network_id: values.network_id
    },
    function(result){
      setValues({ ...values, 
        name: result[0]['forum']['name'],
        description: result[0]['forum']['description']
      });
  ...
  function submit(){
    ...
    userService.sendRequest('/questions/forum/', option, {
        uuid: values.uuid,
        network_id: values.network_id,
        name: values.name,
    ...
    function(result){
        ...
        const msg = values.uuid.length === 0 ? "Forum cadastrado!" : "Forum atualizado!";
