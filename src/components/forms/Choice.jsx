...
function Choice(props) {
  ...
  {
    userService.sendGETRequest('/questions/choice', { 
      uuid: uuid,
      network_id: values.network_id
    },
    function(result){
      setValues({ ...values, 
        name: result[0]['choice']['name'],
        description: result[0]['choice']['description']
      });
  ...
  function submit(){
    ...
    userService.sendRequest('/questions/choice/', option, {
        uuid: values.uuid,
        network_id: values.network_id,
        name: values.name,
